...
public class TableDoubleObjectInspector
    ...
    public double get(Object o) {
        ...
        throw new IllegalArgumentException(
                      "object is not of type Double or type FieldValue");
    }

    @Override
    public Object create(double value) {
        /*
         * It appears that a DoubleValue cannot currently be created from the
         * given primitive value. One would like to be able to do something
         * like:
         *     return FieldValue.createDouble(value);
    ...
    public Object set(Object o, double value) {
         ...
         * the following:
         *
         *    return ((FieldValue) o).getDefinition().createDouble(value);
         *
         ...
         */
        return ((FieldDef) o).createDouble(value);
    }
}
