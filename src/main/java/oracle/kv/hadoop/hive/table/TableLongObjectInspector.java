...
public class TableLongObjectInspector
    ...
    public long get(Object o) {
        ...
        throw new IllegalArgumentException(
                      "object is not of type Long or type FieldValue");
    }

    @Override
    public Object create(long value) {
        /*
         * It appears that a LongValue cannot currently be created from the
         * given primitive value. One would like to be able to do something
         * like:
         *     return FieldValue.createLong(value);
    ...
    public Object set(Object o, long value) {
         ...
         * the following:
         *
         *    return ((FieldValue) o).getDefinition().createLong(value);
         *
         ...
         */
        return ((FieldDef) o).createLong(value);
    }
}
