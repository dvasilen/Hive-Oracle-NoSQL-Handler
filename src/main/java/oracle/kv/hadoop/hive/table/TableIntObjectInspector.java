...
public class TableIntObjectInspector
    ...
    public int get(Object o) {
        ...
        throw new IllegalArgumentException(
                      "object is not of type Integer or type FieldValue");
    }

    @Override
    public Object create(int value) {
        /*
         * It appears that an IntegerValue cannot currently be created from
         * the given primitive value. One would like to be able to do
         * something like:
         *     return FieldValue.createInteger(value);
    ...
    public Object set(Object o, int value) {
         ...
         * the following:
         *
         *    return ((FieldValue) o).getDefinition().createInteger(value);
         *
         ...
         */
        return ((FieldDef) o).createInteger(value);
    }
}
