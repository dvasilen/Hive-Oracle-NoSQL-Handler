...
public class TableBooleanObjectInspector
    ...
    public boolean get(Object o) {
        ...
        throw new IllegalArgumentException(
                      "object is not of type Boolean or type FieldValue");
    }

    @Override
    public Object create(boolean value) {
        /*
         * It appears that a BooleanValue cannot currently be created from the
         * given primitive value. One would like to be able to do something
         * like:
         *     return FieldValue.createBoolean(value);
    ...
    public Object set(Object o, boolean value) {
         ...
         * the following:
         *
         *    return ((FieldValue) o).getDefinition().createBoolean(value);
         *
